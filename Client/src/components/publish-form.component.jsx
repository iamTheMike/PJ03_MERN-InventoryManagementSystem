...
const PublishForm = () => {
  ...
  const handleKeyDown = (e) => {
    if (e.keyCode === 13 || e.keyCode === 188) { //enter and comma
      e.preventDefault();
  ...
  const publishBlog = (e) => {
    ...
    axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/blog/create-blog", blogObj, {
      ...
      .then(() => {
        ...
        toast.success("Publish the blog completely")
    ...
    <AnimationWrapper>
      <section className='w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4'>
        ...
        <div className='border-grey lg:border-1 lg:pl-8'>
          ...
          <textarea
            placeholder={"Write Your Short Description about your blog . . ."}
            maxLength={characterLimit}
            value={des}
            className='h-40 resizr-none leading-7 input-box pl-4'
            onChange={handleBlogDesChange}
            onKeyDown={handleTitleKeyDown}
          >
          </textarea>
          <p className='mt01 text-dark-grey text-sm text-right'>
          ...
          <div className='relative input-box pl-2 py-2 pb-4'>
            <input type="text"
              placeholder='Topic'
              className='sticky input-box bg-white top-0 left-0 pl-4 mb-3 focus:bg-withe'
          ...
          <p className='text-dark-grey mt-1 mb-4 text-right'>
